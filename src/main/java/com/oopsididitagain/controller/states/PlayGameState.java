...
public class PlayGameState extends GameState {
	...
	private PlayGameState() {
		...
		t[1][0].getItems().add(new TakeableItem("Sword", true, Toolkit.getDefaultToolkit().getImage(getClass().getResource("/sword.jpg"))));
		t[7][0].getItems().add(new TakeableItem("Cape", true, Toolkit.getDefaultToolkit().getImage(getClass().getResource("/cape.png"))));
		t[3][3].getItems().add(new TakeableItem("Potion", false, Toolkit.getDefaultToolkit().getImage(getClass().getResource("/potion.jpg"))));
